            ...
            <div class="card">
              <div class="card-body dashboard-tabs p-0">
                <ul class="nav nav-tabs px-4" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="overview-tab" data-bs-toggle="tab" href="#upload" role="tab" aria-controls="overview" aria-selected="true"> <i class="fa-sharp fa-solid fa-plus"></i>Upload Project</a>
                  </li>
                  <!--<li class="nav-item">
                            ...
                            <div class="card-body">
                              ...
                              <form class="forms-sample" enctype="multipart/form-data" action="./helpers/upload.php" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class=" form-control" name="title" value="<?php echo$data["title"];  ?>" placeholder="project Tittle">
                                </div>
                                <div class="form-group">
                                  <label for="name">Students' Full name</label>
                                  <input type="text" class="form-control" name="student_name" value="<?php echo$data["student_name"];  ?>" placeholder="Student name">
                                </div>
                                <div class="form-group">
                                  <label for="name">Supervisor's name</label>
                                  <input type="text" class="form-control" name="supervisor_name" value="<?php echo$data["supervisor_name"];  ?>" placeholder="supervisors name">
                                </div>
                                <div class="form-group">
                                  <label for="date">Project Year</label>
                                  <input type="date" class="form-control" name="project_year" placeholder="Year" value="<?php echo$data["project_year"];  ?>">
                                </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-group col-xs-12">
                                    <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Document" required value="<?php echo $data["file"];  ?>">
